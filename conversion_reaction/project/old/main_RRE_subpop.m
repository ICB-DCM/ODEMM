% generates model and estimates parameters for the RRE model with two
% parameter for all variances, varying between subpopulations
...
options.sigmas = 'subpopulation-specific';
...
save('./project/results/results_RRE_subpop','M','D','parameters','conditions','options')