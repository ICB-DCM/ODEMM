%function [r1,r2,r3,y,r4,sy] = simulate_SP_CR_k1(t,xi,u)
function varargout = simulate_SP_CR_k1(t,xi,u)
%%
%'log_{10}(k_1)','log_{10}(k_{2,s1})',
 %                  'log_{10}(k_3)','log_{10}(mk_4)','log_{10}(vk_4)','log_{10}(k_5)',...
