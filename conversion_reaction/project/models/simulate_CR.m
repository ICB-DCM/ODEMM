function varargout = simulate_CR(varargin)
% simulate_CR.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_CR(tout,theta)
% [...] = simulate_CR(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_CR(...)
%
% INPUTS:
% =======
...
sol = ami_CR(tout,theta(1:3),kappa(1:0),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
