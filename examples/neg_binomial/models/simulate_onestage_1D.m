% simulate_onestage_1D.m is the matlab interface to the cvodes mex
%   which simulates the ordinary differential equation and respective
%   sensitivities according to user specifications.
%   this routine was generated using AMICI commit c92cabe70c2a0e0759cf26e54548adea06673947 in branch master in repo https://github.com/ICB-DCM/AMICI.
%
% USAGE:
% ======
% [...] = simulate_onestage_1D(tout,theta)
% [...] = simulate_onestage_1D(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_onestage_1D(...)
%
% INPUTS:
% =======
...
function varargout = simulate_onestage_1D(varargin)
...
sol = ami_onestage_1D(tout,theta(1:3),kappa(1:0),options_ami,plist,pbar(plist+1),xscale,init,data);
if(nargout>1)
