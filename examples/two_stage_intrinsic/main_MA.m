...
% [g,g_fd_f,g_fd_b,g_fd_c] = testGradient(xi,@(xi) logLikelihood(xi,M,D,[],conditions),1e-4);
...
save ./project/results/geneExp_MA parameters D M options conditions

%% Profile likelihood calculation
options_PL.fmincon = optimset('GradObj','on','display','off','MaxIter',50,...
    'algorithm','trust-region-reflective');
options_PL.parameter_index = 1:parameters.number;
