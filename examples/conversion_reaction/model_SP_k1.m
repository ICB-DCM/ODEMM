...
parameters.name = {'log_{10}(k_{1,s1})','log_{10}(k_{1,s2})','log_{10}(k_2)',...
    'log_{10}(k_3))','log_{10}(\sigma_{k_1}))',...
...
M.model = @(T,theta,u) simulate_SP_CR_k1(T,theta,[]);
...
save('./project/results/results_SP_k1','M','D','parameters','conditions','options')