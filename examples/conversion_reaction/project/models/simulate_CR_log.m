function varargout = simulate_CR_log(varargin)
% simulate_CR_log.m is the matlab interface to the cvodes mex
...
%
% USAGE:
% [...] = simulate_CR_log(tout,theta) \n
% [...] = simulate_CR_log(tout,theta,kappa,data,options) \n
% [status,tout,x,y,sx,sy] = simulate_CR_log(...) \n
%
% Parameters:
...
sol = ami_CR_log(tout,theta(1:3),kappa(1:0),options_ami,plist,pbar,xscale,data);
if(options_ami.sensi==1)
