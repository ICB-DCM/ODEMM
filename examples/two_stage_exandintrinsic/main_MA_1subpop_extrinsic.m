...
parameters.name = {'log_{10}(\mu_{k_1})','log_{10}(\mu_{k_{2}})',...
    'log_{10}(\mu_{k_{3}})',...
    'log_{10}(\mu_{k_4})','log_{10}(\mu_{k_5})','log_{10}(v_{k_1})','log_{10}(v_{k_{2}})',...
    'log_{10}(v_{k_{3}})',...
    'log_{10}(v_{k_4})','log_{10}(v_{k_5})'};

parameters.number = length(parameters.name);
parameters.min = [-5*ones(10,1)];
parameters.max = [ 5*ones(10,1)];
...
save ./results/geneExp_MA_1subpop_extrinsic parameters D M options conditions
...
options_plot.model.col{1} = color.MA_1subpop_extr;
