...
filename = 'KM14_KM101KM103KM105KM107_ERKpERK_ResultsFinal_Cells.csv';
delimiter = '\t';
startRow = 2;
...
repl_names = {'KM14_ECM_150722_KM101_','KM14_ECM_150722_KM103_','KM14_ECM_150727_KM105_',...
    'KM14_ECM_150727_KM107_'};
% number of doses
n_u = 6;
...
for k = 1:n_u
    ...
    for e = I_exp
        ...
        for c = 1:nargin
            ...
            ExpC(k).replicate(j).data{c} = [Ch3(ind), Ch2(ind)];
