...
% This file creats the data structure for the 1D dose response data. For
% the input/output variables see load_NGF_pErk_kin.m.
%
%% Initialize variables.
filename = 'KM14_KM60KM62KM67KM68__ResultsFinal_Cells.csv';
delimiter = '\t';
startRow = 2;
...
rawNumericColumns = raw(:, [2,3,6,7,8,9,10,11]);
...
repl_names = {'KM14_ECM_150304_KM60_','KM14_ECM_150309_KM62_','KM14_ECM_150331_KM67_',...
    'KM14_ECM_150331_KM68_'};
% number of doses
n_u = 7;
