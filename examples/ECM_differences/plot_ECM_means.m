...
box off
set(gcf, 'PaperUnits','centimeters', 'PaperPosition',[0 0 4,2.7])
...
ylabel('pErk1/2 levels [UI]','fontsize',fs)
box off
set(gcf, 'PaperUnits','centimeters', 'PaperPosition',[0 0 5.1,2])
...
% ylabel('pErk1/2 levels [UI]','fontsize',fs)
% box off
% set(gcf, 'PaperUnits','centimeters', 'PaperPosition',[0 0 5.1,2.7])
