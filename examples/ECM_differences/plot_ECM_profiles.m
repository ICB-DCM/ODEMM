...
parameters.name = {'log_{10}(k_1)','log_{10}(k_2)','log_{10}(k_4)','log_{10}(k_{5})',...% parameter for simulation
        ...
        'log_{10}(c_P^{1,2})','log_{10}(c_T/k_3)','log_{10}(o_T)',... % scaling and offset
        'log_{10}(c_E/c_P^{5,6})','log_{10}(o_E)',...
        ...
        'log_{10}(\sigma_{E,noise})','log_{10}(\sigma_{P,noise})',...
        'log_{10}(w_1)','log_{10}(\kappa_{k_5})','log_{10}(\kappa_{k_3[TrkA]_0})','log_{10}(\kappa_{c_{P}^{1,2}Erk})'};
