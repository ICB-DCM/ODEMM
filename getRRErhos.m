...
%  rhos: \n
%      = ''condition-dependent'': (default) assign rho for every time point \n
%      = ''time-dependent'': one rho for every subpopulation and time point \n
...
options.rhos = 'condition-dependent';
if nargin >= 3
    options = varargin{1};
end
if nargin >=4 
