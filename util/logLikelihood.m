...
%       = ''logn_median'': lognormal distribution assumption, mean of simulation linked to median of distribution\n
%       = ''logn_mean'': lognormal distribution assumption, mean of simulation linked to mean of distribution\n
...
%   n_dim: dimension of the measurements (if n_dim > 2, toolbox needs
%       to be extended at some points!!)
